...
echo_and_run cd "/home/adwaith/host/gem_simulation_ws/src/POLARIS_GEM_Simulator/ros_drivers/jsk_rviz/jsk_topic_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/adwaith/host/gem_simulation_ws/src/POLARIS_GEM_Simulator/ros_drivers/jsk_rviz/jsk_topic_tools/setup.py" \
     \
    build --build-base "/home/adwaith/host/gem_simulation_ws/build/POLARIS_GEM_Simulator/ros_drivers/jsk_rviz/jsk_topic_tools" \
    install \
    --root="${DESTDIR-/}" \
